...
const WIX_API_KEY = (process.env.WIX_API_KEY && process.env.WIX_API_KEY.trim())
...
const WIX_SITE_ID = (process.env.WIX_SITE_ID && process.env.WIX_SITE_ID.trim())
  ? process.env.WIX_SITE_ID.trim()
  : "bcc24467-7d67-4dc3-a70c-75cc5c6467fb";
