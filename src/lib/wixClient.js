...
export async function createWixLeadContact(leadData = {}) {
  const contactPayload = {
    firstName: (leadData.firstName || "Website").trim(),
    lastName: (leadData.lastName || "Lead").trim(),
    ...
    projectTypes: leadData.projectTypes || [],
  ...
  try {
    ...
    console.log("✅ Wix CRM Lead Created via Wix SDK:", response);
    return response;
  } catch (error) {
